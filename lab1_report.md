...
## 6. Макеты интерфейса (Описание)
1. **Дашборд Пациента:** Список карточек препаратов на сегодня с чекбоксами "Принял".
2. **Кабинет Врача:** Форма с выпадающим списком препаратов и календарем для выбора дат курса.
3. **Админ-панель:** Табличный вид справочников с кнопками "Добавить/Редактировать".
